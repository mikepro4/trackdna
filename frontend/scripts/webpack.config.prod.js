...
config.module.loaders.push({
  test: /^((?!\.module).)*\.s?css$/,
  loader: ExtractTextPlugin.extract('style-loader', 'css!resolve-url!postcss!sass')
})
config.module.loaders.push({
  test: /\.module\.s?css$/,
  loader: ExtractTextPlugin.extract('style', 'css?modules&importLoaders=1!resolve-url!postcss!sass')
})
